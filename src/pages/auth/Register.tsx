...
import { Eye, EyeOff, Mail, Lock, User, Zap, ArrowRight, Building } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="font-display text-3xl font-bold mb-4">
            Join FlowGateX Today
          </h2>
          <p className="text-muted-foreground max-w-md">
            Create unforgettable event experiences with our smart IoT platform.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            Get started with FlowGateX today
          </p>
